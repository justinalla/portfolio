...
export const projects: Project[] = [
  ...
  {
    slug: 'nova', number: '02', name: 'Shopify & Liquid sur mesure', category: 'E-commerce · Développement', mark: '{%}', color: 'clay', service: true,
    tags: ['Shopify', 'Liquid', 'ChatGPT & Claude'], filters: ['commerce', 'ia'],
    summary: 'Une boutique à votre image, sans achat de thème premium. Développement Liquid sur mesure et intégrations IA adaptées à votre activité.',
    role: 'Développement Shopify, personnalisation Liquid et intégrations IA',
    problem: 'Vous souhaitez une boutique professionnelle sans consacrer une part importante de votre budget à un thème payant. Votre identité, vos produits et votre parcours client méritent une conception adaptée.',
    approach: 'Je pars d’un thème Shopify gratuit pour construire les sections et fonctionnalités utiles en Liquid, HTML, CSS et JavaScript. L’objectif : une boutique personnalisée, facile à administrer et adaptée au mobile.',
    deliverables: ['Thème gratuit personnalisé et sections Liquid configurables', 'Pages produit et parcours d’achat adaptés à votre offre', 'Vérifications sur mobile et ordinateur', 'Intégrations IA selon le périmètre convenu', 'Code livré et documentation de prise en main'],
    tech: ['Shopify', 'Liquid', 'JavaScript', 'API OpenAI', 'API Anthropic'],
    note: 'L’abonnement Shopify, le développement et les éventuels services tiers restent à prévoir. Les intégrations IA sont proposées sur mesure et ne sont pas présentées comme déjà déployées.',
  },
  {
